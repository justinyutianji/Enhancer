...
output_dir = '/pmglocal/ty2514/Enhancer/Enhancer/data/ExplaiNN3_G+G-_Rep1'
os.makedirs(output_dir, exist_ok=True)
# Save the R_square results to a CSV file
filename = os.path.join(output_dir, 'ExplaiNN3_G+G-_Rep1_Metrics.csv')
# Split the dataset
...
output_dir = '/pmglocal/ty2514/Enhancer/Enhancer/data/ExplaiNN3_G+G-_Rep2'
os.makedirs(output_dir, exist_ok=True)
# Save the R_square results to a CSV file
filename = os.path.join(output_dir, 'ExplaiNN3_G+G-_Rep2_Metrics.csv')
# Split the dataset
for seed in seeds_cnn: 
    for batch in batches:
        for cnn in num_cnns:
...
batches = [96,168]
num_cnns = list(range(5, 111, 5))
dropout = 0.3
lrs = [1e-4, 5e-4, 1e-3]
target_labels = ['GFP']

output_dir = '/pmglocal/ty2514/Enhancer/Enhancer/data/ExplaiNN3_GFP_Rep1'
os.makedirs(output_dir, exist_ok=True)
# Save the R_square results to a CSV file
filename = os.path.join(output_dir, 'ExplaiNN3_GFP_Rep1_Metrics.csv')
# Split the dataset
for seed in seeds_cnn: 
    for batch in batches:
        for cnn in num_cnns:
...
output_dir = '/pmglocal/ty2514/Enhancer/Enhancer/data/ExplaiNN3_GFP_Rep2'
os.makedirs(output_dir, exist_ok=True)
# Save the R_square results to a CSV file
filename = os.path.join(output_dir, 'ExplaiNN3_GFP_Rep2_Metrics.csv')
# Split the dataset
for seed in seeds_cnn: 
    for batch in batches:
        for cnn in num_cnns:
