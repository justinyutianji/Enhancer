...
output_dir = '/pmglocal/ty2514/Enhancer/Enhancer/data/Synthetic_Freq_Results/ExplaiNN_Interaction2_synthetic_freq_results'
...
input_model = ExplaiNN3_interact2(num_cnns = num_cnns, input_length = 608, num_classes = 1, 
                 ...
                 drop_out = drop_out, weight_path = None)# Training
...
model_path = f'/pmglocal/ty2514/Enhancer/Enhancer/data/Synthetic_Freq_Results/ExplaiNN_Interaction2_synthetic_freq_results/model_epoch_{best_r2_epoch}.pth'
dir_path = '/pmglocal/ty2514/Enhancer/Enhancer/data/Synthetic_Freq_Results/ExplaiNN_Interaction2_synthetic_freq_results'
